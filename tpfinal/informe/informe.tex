...
El procedimiento para evitar obstaculos consiste en buscar un punto, en la región de interes, al cual dirigirse que este relativamente cerca del robot y en el que  ningún objeto.
...
\subsubsection{Heurística de la disparidad media}
...
Usando propiedades trigonometricas calculamos el ángulo de giro y la distancia.
